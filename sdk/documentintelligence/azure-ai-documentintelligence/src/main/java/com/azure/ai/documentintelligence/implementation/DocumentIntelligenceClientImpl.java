...
public final class DocumentIntelligenceClientImpl {
    ...
    public Mono<Response<BinaryData>> getAnalyzeResultWithResponseAsync(String modelId, String resultId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getAnalyzeResult(this.getEndpoint(),
    ...
    public Response<BinaryData> getAnalyzeResultWithResponse(String modelId, String resultId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getAnalyzeResultSync(this.getEndpoint(), this.getServiceVersion().getVersion(), modelId,
